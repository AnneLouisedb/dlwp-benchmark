...
# Parts of the code in this file have been adapted from WeatherLearn repo Copyright (c) Zhuoqun Li


"""
A PyTorch implementation of Pangu-Weather adopted from 
https://github.com/lizhuoq/WeatherLearn/blob/master/weatherlearn/models/pangu/pangu.py
"""
...
from models.panguweather.utils.earth_position_index import get_earth_position_index
from models.panguweather.utils.shift_window_mask import get_shift_window_mask, window_partition, window_reverse
from models.panguweather.utils.patch_embed import PatchEmbed2D
from models.panguweather.utils.patch_recovery import PatchRecovery2D
from models.panguweather.utils.pad import get_pad3d
from models.panguweather.utils.crop import crop3d
...
class PanguWeather(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        img_size = (1, n_lat//patch_size[0], n_lon//patch_size[1])
        ...
        img_size_next = (1, img_size[1]//2, img_size[2]//2)
        self.downsample = DownSample(in_dim=embed_dim, input_resolution=img_size, output_resolution=img_size_next)
        self.layer2 = BasicLayer(
            dim=embed_dim * 2,
            input_resolution=img_size_next,
            depth=6,
        ...
        self.upsample = UpSample(embed_dim * 2, embed_dim, img_size_next, img_size)
        ...
        self.patchrecovery2d = PatchRecovery2D((n_lat, n_lon), patch_size, 2 * embed_dim, prognostic_channels)
