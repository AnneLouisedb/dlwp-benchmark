...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(
        ...
        self.h = th.zeros(size=(self.batch_size, hidden_size, height, width), device=device)
        self.c = th.zeros(size=(self.batch_size, hidden_size, height, width), device=device)
